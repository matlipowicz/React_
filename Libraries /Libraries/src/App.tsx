...
import Payment from 'src/components/clients_form/payment/Payment';
...
import { store } from 'src/redux/store/Money';
...
const Invoices = React.lazy(() => import('./components/pages/Invoices/Invoices'));
